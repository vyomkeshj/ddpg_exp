...
from models.ac_model_ddpg import Critic, Actor
...
class DDPGAgent:
    ...
    def __init__(self, env, gamma, tau, buffer_maxlen, critic_learning_rate, actor_learning_rate):
        ...
        #print("observation space size = %d" %self.obs_dim)
    ...
    def get_action(self, obs):
        ...
        #print("get action: before loss",action)
        #print("get action: ",action*4.00000)
        return action
